...
import 'package:famdoc_user/medireminder/src/common/convert_time.dart';
import 'package:famdoc_user/medireminder/src/global_bloc.dart';
import 'package:famdoc_user/medireminder/src/models/errors.dart';
import 'package:famdoc_user/medireminder/src/models/medicine.dart';
import 'package:famdoc_user/medireminder/src/models/medicine_type.dart';
import 'package:famdoc_user/medireminder/src/ui/homepage/homepage.dart';
import 'package:famdoc_user/medireminder/src/ui/new_entry/new_entry_bloc.dart';
import 'package:famdoc_user/medireminder/src/ui/success_screen/success_screen.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => MediHomePage()),
    );
  }
    ...
    if (picked_s != null && picked_s != selectedTime) {
      ...
      setState(() {
        ...
        _newEntryBloc.updateTime(
            "${convertTime(selectedTime.hour.toString())}" +

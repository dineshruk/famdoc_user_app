...
class CouponWidget extends StatefulWidget {
  final String couponDoctor;
  CouponWidget(this.couponDoctor);
  @override
                ...
                AbsorbPointer(
                  ...
                  child: OutlineButton(
                    ...
                    onPressed: () {
                      ...
                      _coupon
                          .getCouponDetails(
                              _couponText.text, widget.couponDoctor)
                          .then((value) {
    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
            ...
            content: Text(
                'This Discount Coupon $code you have enetred is $validity.Please try with another code'),
            actions: [
              FlatButton(
                child: Text(
                  'OK',
